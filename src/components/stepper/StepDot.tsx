        ...
        <div className="flex items-center gap-1.5">
            <div
                className={`h-8 w-8 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 ${completed
                    ...
                    : active
                        ? "bg-linear-to-br from-yellow-500 to-red-500 text-white shadow-md"
            ...
            <span
                className={`text-xs font-medium whitespace-nowrap ${active ? "text-yellow-700" : completed ? "text-yellow-600" : "text-gray-400"
                    }`}
            >
                {label}
            </span>
